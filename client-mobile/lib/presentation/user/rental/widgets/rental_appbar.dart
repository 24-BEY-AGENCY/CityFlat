...
class RentalAppbar extends StatefulWidget {
  final String? title;
  final Function()? onPressed;

  const RentalAppbar({super.key, this.title, this.onPressed});

  @override
  State<RentalAppbar> createState() => _RentalAppbarState();
}

class _RentalAppbarState extends State<RentalAppbar> {
  User? userData;
