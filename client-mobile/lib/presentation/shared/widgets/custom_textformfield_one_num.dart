...
class CustomTextFormFieldOneNumber extends StatelessWidget {
  const CustomTextFormFieldOneNumber(
      {Key? key,
      this.initialValue,
      this.enabled,
    ...
    return Neumorphic(
      ...
      style: NeumorphicStyle(
        boxShape: NeumorphicBoxShape.roundRect(
            BorderRadius.circular(customBorderRadius ?? 50.0)),
        depth: -3,
        intensity: 0.6,
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(customBorderRadius ?? 50.0),
